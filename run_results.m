...
C850 = [(4*pi/lamb850)^2 1/(hbs850*hprobe)^2];
...
d850=[4*pi*hbs850*hprobe/lamb850];
...
S_850 = eq7_M_PL_models(C850, gamma, d850, R850, EIRP, f850);
...
S = S_700 + S_850 + S_1800 + S_2100 + S_2600;
TER = ER_700 + ER_850 + ER_1800 + ER_2100 + ER_2600;

fprintf('Frequency\tS\t\t\tS_lim\t\tER\n');
fprintf('%2f\t%2f\t%2f\t%2f\n', 700, S_700, S_lim_700, ER_700);
fprintf('%2f\t%2f\t%2f\t%2f\n', 850, S_850, S_lim_850, ER_850);
